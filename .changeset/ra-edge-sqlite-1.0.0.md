---
"rest-worker-types": major
"core-rest-worker": major
"d1-rest-worker": major
"turso-rest-worker": major
"ra-cloudflare-d1": major
"ra-turso": major
"create-d1-rest-worker": major
"create-turso-rest-worker": major
---

1.0.0 — the project is now **ra-edge-sqlite**: React-Admin data providers and
